...
- [cisagov/admiral](https://github.com/cisagov/admiral) ([v3.0.0](https://github.com/cisagov/admiral/releases/tag/v3.0.0), 1 day ago) - Distributed certificate transparency log harvester
- [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ([v10.3.4](https://github.com/projectdiscovery/nuclei-templates/releases/tag/v10.3.4), 5 days ago) - Community curated list of templates for the nuclei engine to find security vulnerabilities.
