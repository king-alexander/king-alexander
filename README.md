...
- [king-alexander/king-alexander.github.io](https://github.com/king-alexander/king-alexander.github.io) -  (2 days ago)
- [cisagov/ansible-role-admiral](https://github.com/cisagov/ansible-role-admiral) - Ansible Role to install the Admiral for Certificate Transparency scanning (6 days ago)
...
- [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ([v10.3.4](https://github.com/projectdiscovery/nuclei-templates/releases/tag/v10.3.4), 2 days ago) - Community curated list of templates for the nuclei engine to find security vulnerabilities.
- [cisagov/ansible-role-admiral](https://github.com/cisagov/ansible-role-admiral) ([v1.0.0](https://github.com/cisagov/ansible-role-admiral/releases/tag/v1.0.0), 6 days ago) - Ansible Role to install the Admiral for Certificate Transparency scanning
