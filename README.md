...
- [cisagov/ansible-role-admiral](https://github.com/cisagov/ansible-role-admiral) - Ansible Role to install the Admiral for Certificate Transparency scanning (5 days ago)
...
- [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ([v10.3.4](https://github.com/projectdiscovery/nuclei-templates/releases/tag/v10.3.4), 1 day ago) - Community curated list of templates for the nuclei engine to find security vulnerabilities.
- [cisagov/ansible-role-admiral](https://github.com/cisagov/ansible-role-admiral) ([v1.0.0](https://github.com/cisagov/ansible-role-admiral/releases/tag/v1.0.0), 5 days ago) - Ansible Role to install the Admiral for Certificate Transparency scanning
- [cisagov/admiral](https://github.com/cisagov/admiral) ([v3.0.0-rc.1](https://github.com/cisagov/admiral/releases/tag/v3.0.0-rc.1), 6 days ago) - Distributed certificate transparency log harvester
