...
- [cisagov/admiral-docker](https://github.com/cisagov/admiral-docker) - Docker components for the dreaded Rear Admiral (1 week ago)
...
- [cisagov/ansible-role-admiral](https://github.com/cisagov/ansible-role-admiral) ([v1.0.0](https://github.com/cisagov/ansible-role-admiral/releases/tag/v1.0.0), 1 day ago) - Ansible Role to install the Admiral for Certificate Transparency scanning
- [cisagov/admiral](https://github.com/cisagov/admiral) ([v3.0.0-rc.1](https://github.com/cisagov/admiral/releases/tag/v3.0.0-rc.1), 2 days ago) - Distributed certificate transparency log harvester
