...
- [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) ([v10.3.6](https://github.com/projectdiscovery/nuclei-templates/releases/tag/v10.3.6), 4 days ago) - Community curated list of templates for the nuclei engine to find security vulnerabilities.
- [cisagov/ansible-role-admiral](https://github.com/cisagov/ansible-role-admiral) ([v2.0.0](https://github.com/cisagov/ansible-role-admiral/releases/tag/v2.0.0), 6 days ago) - Ansible Role to install the Admiral for Certificate Transparency scanning
